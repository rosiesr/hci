...
let frames = {
  ...
  get_left_wrist_command: function (frame) {
    ...
    let pelvis_y = frame.people[0].joints[0].position.y;
    let pelvis_z = frame.people[0].joints[0].position.z;
    let left_wrist_x = (frame.people[0].joints[7].position.x - pelvis_x) * -1;
    let left_wrist_y = (frame.people[0].joints[7].position.y - pelvis_y) * -1;
    let left_wrist_z = (frame.people[0].joints[7].position.z - pelvis_z) * -1;
